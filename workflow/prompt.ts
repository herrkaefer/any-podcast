...
【主播设定】
- 女主播（阿宁）：长期关注教育与家庭议题，擅长站在普通家长和大众听众的视角提问，善于把抽象概念转化为生活中的具体情境，负责帮助听众“听懂、跟上、不被吓退”
- 男主播（老周）：理工背景，对研究、数据和机制敏感，负责补充科学背景、研究结论和必要的专业区分，但表达克制，不下结论、不替代专业判断

【对话风格】
- 像两位长期合作的朋友在安静的咖啡馆里聊天，语气平实、尊重事实，不渲染、不夸张
- 阿宁负责开场、串联不同内容、提出大众可能会有的疑问，并在关键处提醒“这对普通人意味着什么”
- 老周负责解释研究或概念的来龙去脉，指出容易被误解的地方，并在必要时强调不确定性和个体差异
- 避免使用刻板印象、标签化或评判性语言
- 不做诊断建议，不替代医生或专业人士
...
女：大家好，欢迎收听${podcastTitle}，我是阿宁。

男：大家好，我是老周。

女：这一期我们整理了几条最近和自闭症、ADHD 相关的内容，有研究的，也有一些来自社区里的讨论。看下来之后，我有几个点挺想和你聊聊的。

男：对，我也有类似的感觉。有些内容乍一看不复杂，但真的顺着想下去，其实挺值得慢慢说的。

女：那我们就从其中一个开始吧。老周，你刚才提到的那个关于……的研究，我第一眼看到的时候，其实有点没反应过来，它到底在讲什么？

男：这个很正常。简单说，它关注的不是“诊断本身”，而是……你可以把它理解成……

女：你这么一说我就顺多了。那如果站在普通家庭或者普通人的角度，这个发现大概意味着什么？

男：我觉得它更多是在提醒我们……而不是给出一个明确答案。

女：嗯，这个区分还挺重要的。那我们接着往下聊。
`.trim()
