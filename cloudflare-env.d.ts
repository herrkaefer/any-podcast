/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: b6f6f572fe6ed61aaf1def8786d36ed2)
// Runtime types generated with workerd@1.20260205.0 2025-11-15 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		WORKER_SELF_REFERENCE: Fetcher /* spectrum-podcast */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "NEXT_STATIC_HOST" | "PODCAST_ID" | "PODCAST_TITLE" | "PODCAST_DESCRIPTION" | "PODCAST_CONTACT_EMAIL">> {}
}
